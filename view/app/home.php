    ...
    <header class="navbar-2life">
        <div class="container-fluid px-4">
            <div class="row align-items-center g-2">
                <div class="col-2"><a href="index.php?controller=home" class="logo">2Life</a></div>
                <div class="col-5">
...
<span class="text-white fw-bold ms-2">
    <i class="bi bi-person-circle"></i> Chào, <?= htmlspecialchars($_SESSION['username'] ?? 'Thành viên') ?>
                        ...
                        <a href="index.php?controller=auth&action=logout" class="text-danger ms-2" style="font-size:13px; text-decoration:none;">(Đăng xuất)</a>
                    <?php else: ?>
                        <a href="index.php?controller=auth&action=login" class="btn-2life-outline" style="color: white; border-color: white;">Đăng nhập</a>
                        <a href="index.php?controller=auth&action=register" class="btn-2life-primary">Đăng ký</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
