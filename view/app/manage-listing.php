        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" style="font-size: 14px;">
                ...
                <tbody>
                        ...
                        <?php foreach ($listings as $item): ?>
                            <tr id="row-<?= $item['id'] ?>">
                                ...
                                <td class="pe-4 text-end">
                                    <button class="btn btn-sm btn-outline-primary me-1" data-id="<?= $item['id'] ?>" data-status="<?= $item['status_id'] ?>" onclick="manageListing_viewDetail(this)">
                                        <i class="bi bi-eye"></i>
                                    </button>

                                    <?php if ($item['status_id'] != 4 && $item['status_id'] != 1): ?>
                                        <button data-href="index.php?controller=manage_listing&action=changeStatus&type=hide&id=<?= $item['id'] ?>" data-id="<?= $item['id'] ?>" class="btn btn-sm btn-outline-secondary" onclick="manageListing_hideListing(event, this)">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" class="text-center py-5 text-secondary">Không tìm thấy tin đăng nào.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-danger" id="btn-delete-listing" onclick="manageListing_deleteListing()"><i class="bi bi-trash"></i> Xóa tin</button>
                <div>
